<template>
  ...
  >
    ...
    <q-linear-progress
      ...
      class="ma-0"
    />
    <div class="credits-own caption text-grey-6">
      Generated by BM|Desginer
      <a href="https://bmdesigner.com" target="_blank" class="text-grey-4">(bmdesigner.com)</a>
    </div>
    <div class="credits caption text-grey-6">
      <a
      ...
      >
      by
      <a href="http://strategyzer.com" target="_blank" class="text-grey-4">Strategyzer AG</a> is
      licensed under
      <a href="http://creativecommons.org/licenses/by-sa/3.0" target="_blank" class="text-grey-4"
        >CC BY-SA 3.0</a
      >
    </div>
    <image-zone
...
function handleWindowResize() {
  ...
  instance.proxy.$el.style.setProperty(
    '--zoneLabelFontSize',
    `${paper.value.offsetHeight * 0.02}px`,
  )
  instance.proxy.$el.style.setProperty(
...
function fetchData() {
  const zoomed =
    zoomNoteKey(route.query.zoom1 as string) || zoomNoteKey(route.query.zoom2 as string)
  if (!zoomed) {
